...
// Görseli buraya import edeceğiz, şimdilik placeholder kullanıyoruz.
    ...
    <section className="bg-white text-brand-dark">
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        ...
        <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
          {/* Elindeki görseli src/assets klasörüne attıktan sonra aşağıdaki satırı kullanacağız */}
          {/* <img className="object-cover object-center rounded" alt="NutriAI uygulama ekranı" src={appMockup} /> */}
          
          {/* Şimdilik bir placeholder kullanıyoruz */}
          <img 
            className="object-cover object-center rounded-2xl shadow-2xl" 
            alt="Uygulama görseli" 
            src="https://placehold.co/400x700/A2D2FF/FFFFFF?text=NutriAI\nApp" 
          />
        </div>
      </div>
    </section>
