      ...
      <div className="container mx-auto px-6 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left">
          <div className="mb-4 md:mb-0">
            ...
            <div className="mt-2">
              {/* Linkleri güncelledik */}
              <Link to="/yasal" className="text-sm text-gray-500 hover:text-brand-purple mr-4">Gizlilik & KVKK</Link>
              <Link to="/sss" className="text-sm text-gray-500 hover:text-brand-purple">Sıkça Sorulan Sorular</Link>
            </div>
          </div>
