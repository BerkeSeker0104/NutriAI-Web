// src/components/Hero.jsx - Buton Görünürlük Düzeltmesi
...
const FloatingIcon = ({ icon, className, animation }) => (
  <motion.div
    className={`absolute z-0 text-brand-blue/40 hidden md:block ${className}`}
...
const Hero = () => {
  return (
    <section className="relative bg-white text-brand-dark overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          >
            <a 
              href="#nasil-calisir" 
              className="inline-block text-white bg-brand-green border-0 py-3 px-8 focus:outline-none hover:bg-green-600 rounded-lg text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
            >
              Hemen Keşfet
            </a>
            <a 
              href="#kayit-formu" 
              className="inline-block text-gray-700 bg-gray-100 border-0 py-3 px-8 focus:outline-none hover:bg-gray-200 rounded-lg text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
            >
              Kurucu Üye Ol
            </a>
          </motion.div>
          {/* --- DÜZELTİLMİŞ BUTON BÖLÜMÜ SONU --- */}
        </div>
